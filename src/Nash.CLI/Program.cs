...
using Nash.NLU.GoogleHC;
using Nash.NLU.ExpertAI;
using Nash.FHIR;
...
namespace Nash.CLI
{
    class Program : Runtime
    {
        ...
        {
            CO.WriteLine(FiggleFonts.Chunky.Render("Nash"), Color.Red);
        ...
        {
            Error((Exception)e.ExceptionObject, "Unhandled error occurred during operation. Nash CLI will now shutdown.");
