...
namespace Nash
{
    public abstract class Runtime
    {
        ...
        static Runtime()
        {
            ...
            else if (Assembly.GetEntryAssembly().GetName().Name == "Nash.CLI" && Environment.GetEnvironmentVariable("USERNAME") == "Allister")
            {
                Configuration = new ConfigurationBuilder()
            ...
            else if (Assembly.GetEntryAssembly().GetName().Name == "Nash.Web" && Environment.GetEnvironmentVariable("USERNAME") == "Allister")
            {
                Configuration = new ConfigurationBuilder()
                    .AddUserSecrets("f3ed0dc7-f978-44ae-8add-9e5bfcf8fa8a")
                    .Build();
            ...
            HttpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Nash/0.1");
        }
