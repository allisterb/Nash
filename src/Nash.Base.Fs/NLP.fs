...
module PennTreebankIITags =
    ...
    type PennTreebankIITags =
        ...
        /// <summary>
        /// Not a Constituent
        /// <para> used to show the scope of certain prenoNashl modifiers within an NP.</para>
        /// </summary>
        | NAC 
        ...
        /// 'him', etc.), the reflexive pronouns ending in -self or -selves, and the noNashl possessive pronouns 'mine',
        ...
        /// The noNashl possessive pronouns 'mine', 'yours', 'his', 'hers', 'ours' and 'theirs' are tagged as personal pronouns (PRP). </para>
        /// </summary>
        | PRPS
        /// <summary>
        /// Particle. 
